class ChatbotJob < ApplicationJob
  ...
  def messages_for_openai
    ...
    If the student has not uploaded any materials yet, gently suggest they click on #{@chat.study.subject.name} in the sidebar and click the Upload New Material button so you can provide more targeted help.
